 ...
 */
export const githubStatusAuthGithubStatusGet = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<GithubStatusAuthGithubStatusGetData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    GithubStatusAuthGithubStatusGetResponses,
    GithubStatusAuthGithubStatusGetErrors,
    ThrowOnError
  >({ url: '/auth/github/status', ...options })
 ...
 */
export const githubLoginAuthGithubGet = <ThrowOnError extends boolean = false>(
  options?: Options<GithubLoginAuthGithubGetData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    GithubLoginAuthGithubGetResponses,
    GithubLoginAuthGithubGetErrors,
    ThrowOnError
  >({ url: '/auth/github', ...options })
 ...
 */
export const githubCallbackAuthGithubCallbackGet = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<GithubCallbackAuthGithubCallbackGetData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    GithubCallbackAuthGithubCallbackGetResponses,
    GithubCallbackAuthGithubCallbackGetErrors,
