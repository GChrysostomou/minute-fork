...
export const listWorkflowsWorkflowsGetOptions = (
  ...
  queryOptions<
    ...
    ListWorkflowsWorkflowsGetError,
    ListWorkflowsWorkflowsGetResponse,
    ReturnType<typeof listWorkflowsWorkflowsGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const getWorkflowRunWorkflowsRunIdGetOptions = (
  ...
  queryOptions<
    ...
    GetWorkflowRunWorkflowsRunIdGetError,
    GetWorkflowRunWorkflowsRunIdGetResponse,
    ReturnType<typeof getWorkflowRunWorkflowsRunIdGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
...
export const githubStatusAuthGithubStatusGetQueryKey = (
  options?: Options<GithubStatusAuthGithubStatusGetData>
) => createQueryKey('githubStatusAuthGithubStatusGet', options)
 ...
 */
export const githubStatusAuthGithubStatusGetOptions = (
  options?: Options<GithubStatusAuthGithubStatusGetData>
) =>
  queryOptions<
    GithubStatusAuthGithubStatusGetResponse,
    GithubStatusAuthGithubStatusGetError,
    GithubStatusAuthGithubStatusGetResponse,
    ReturnType<typeof githubStatusAuthGithubStatusGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await githubStatusAuthGithubStatusGet({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: githubStatusAuthGithubStatusGetQueryKey(options),
  })

export const githubLoginAuthGithubGetQueryKey = (
  options?: Options<GithubLoginAuthGithubGetData>
) => createQueryKey('githubLoginAuthGithubGet', options)
 ...
 */
export const githubLoginAuthGithubGetOptions = (
  options?: Options<GithubLoginAuthGithubGetData>
) =>
  queryOptions<
    unknown,
    GithubLoginAuthGithubGetError,
    unknown,
    ReturnType<typeof githubLoginAuthGithubGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await githubLoginAuthGithubGet({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: githubLoginAuthGithubGetQueryKey(options),
  })

export const githubCallbackAuthGithubCallbackGetQueryKey = (
  options?: Options<GithubCallbackAuthGithubCallbackGetData>
) => createQueryKey('githubCallbackAuthGithubCallbackGet', options)
 ...
 */
export const githubCallbackAuthGithubCallbackGetOptions = (
  options?: Options<GithubCallbackAuthGithubCallbackGetData>
) =>
  queryOptions<
    unknown,
    GithubCallbackAuthGithubCallbackGetError,
    unknown,
    ReturnType<typeof githubCallbackAuthGithubCallbackGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
